...
const featured_bg_image = require('../assets/images/featured_bg_image.jpeg');
const mobile_image = require('../assets/images/mobile_image.png');
const pdf = require('../assets/images/pdf.png');
const profile = require('../assets/images/student_2.png');
...
const thumbnail_2 = require('../assets/images/thumbnail_2d.png');
